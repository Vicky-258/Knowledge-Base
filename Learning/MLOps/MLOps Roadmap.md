...
- Add logging, config management, error handling
...
~~- **Day 12:** CI pipne: Lint → Test → Build Dockere~~
    
- **Day 13:** Auto-push Docker images to DockerHub
...
- **Day 16:** Deploy your Docker image to ECR
    
- **Day 17:** Learn ECS basics (tasks/services/clusters)
    
- **Day 18:** Deploy your FastAPI container to ECS Fargate
    
- **Day 19:** Add load balancer (ALB)
    
- **Day 20:** Add autoscaling
...
- **Day 23:** API health checks, status endpoints
    
- **Day 24:** Metrics basics (latency, throughput, errors)
    
- **Day 25:** Monitoring dashboards (CloudWatch / Prometheus basics)
    
- **Day 26:** Versioning ML models like a pro
...
- Deploy a containerized ML service on a k8s cluster
...
- **Day 30:** Install Minikube (local k8s)
    
- **Day 31:** Deploy your service
    
- **Day 32:** Autoscaling (HPA)
